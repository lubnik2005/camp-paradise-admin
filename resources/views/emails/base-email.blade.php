...
<body style="background-color: #f4f5fb;">
      ...
      <![endif]-->
        <div
            ...
            <div style="line-height: 0; font-size: 0;">
                <table align="center" background="#1c6937" border="0" cellpadding="0" cellspacing="0"
                    role="presentation"
                    style="
    ...
    <![endif]-->
      ...
      <![endif]-->
        <div
            style="background: #ffffff; background-color: #ffffff; margin: 0px auto; border-radius: 20px; max-width: 600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
      ...
      <![endif]-->
        <div
            style="background: #edeef6; background-color: #edeef6; margin: 0px auto; border-radius: 20px; max-width: 600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                                ...
                                                                <td
                                                                    ...
                                                                    <a href="#" target="_blank"
                                                                        ...
                                                                        <img alt="twitter-logo" height="24"
                                                                            src="../../../images/social/light/twitter-logo-transparent-light.png"
                                                                ...
                                                                <td
                                                                    ...
                                                                    <a href="#" target="_blank"
                                                                        ...
                                                                        <img alt="youtube-logo" height="24"
                                                                            src="../../../images/social/light/youtube-logo-transparent-light.png"
                                                                            style="border-radius: 3px; display: block;"
                                                                            width="24" />
                                                                    </a>
                                                                </td>
      ...
      <![endif]-->
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;"
            ...
            <tr>
                <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                    <div
                        style="background: none; background-color: none; margin: 0px auto; border-radius: 20px; max-width: 600px;">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                            style="background: none; background-color: none; width: 100%; border-radius: 20px;">
                            <tbody>
                                <tr>
                                    <td style="direction: ltr; font-size: 0px; padding: 20px 0; text-align: center;">
                                        <div class="mj-column-per-100 mj-outlook-group-fix"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        style="font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                                        <div
                                                            style="font-family: Montserrat, Helvetica, Arial, sans-serif; font-size: 10px; font-weight: 400; line-height: 10px; text-align: center; color: #8189a9;">
                                                            @yield('footer')
                                                        </div>
                                                    </td>
                                                </tr>
